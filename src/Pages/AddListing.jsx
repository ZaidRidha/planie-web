      ...
      <main className="pd-main">
        ...
        <header className="al-header pd-animate pd-d1">
          ...
          <div>
            ...
            <p style={{ margin: "8px 0 0", fontSize: 15, opacity: 0.6 }}>
              {currentDraftId
                ? "Save again any time — it stays a draft until you submit."
        ...
        <form onSubmit={handleSubmit} className="al-form">
          ...
          <div className="al-submit-row pd-animate pd-d4">
            ...
            <button type="submit" className={`pd-btn pd-btn--primary al-submit-btn${submitting ? " is-busy" : ""}`} disabled={submitting}>
              {submitting ? <>Submitting<span className="busy-dots" /></> : "Submit Listing"}
            </button>
          </div>
          {submitError && (
